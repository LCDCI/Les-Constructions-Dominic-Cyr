...
class LotTest {
    ...
    private static final String LOT_NUMBER = "Lot-42";
    ...
    void constructor_InitializesFieldsCorrectly() {
        ...
        Lot lot = new Lot(lotIdentifier, LOT_NUMBER, CIVIC_ADDRESS, PRICE, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, STATUS);
        ...
        assertEquals(LOT_NUMBER, lot.getLotNumber(), "Lot number should match the one provided");
    ...
    void setters_WorkCorrectly() {
        ...
        assertEquals(newLotNumber, lot.getLotNumber());
    ...
    void constructor_NullLotIdentifier_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(null, LOT_NUMBER, CIVIC_ADDRESS, PRICE, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, STATUS);
        });
    }

    @Test
    @DisplayName("Constructor throws NullPointerException when lot number is null")
    void constructor_NullLotNumber_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, null, CIVIC_ADDRESS, PRICE, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, STATUS);
        });
    }
    ...
    void constructor_NullCivicAddress_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, LOT_NUMBER, null, PRICE, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, STATUS);
        });
    }
    ...
    void constructor_NullPrice_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, LOT_NUMBER, CIVIC_ADDRESS, null, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, STATUS);
        });
    }
    ...
    void constructor_NullDimensionsSquareFeet_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, LOT_NUMBER, CIVIC_ADDRESS, PRICE, null, DIMENSIONS_SQ_M, STATUS);
        });
    }
    ...
    void constructor_NullDimensionsSquareMeters_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, LOT_NUMBER, CIVIC_ADDRESS, PRICE, DIMENSIONS_SQ_FT, null, STATUS);
        });
    }
    ...
    void constructor_NullLotStatus_ThrowsNPE() {
        assertThrows(NullPointerException.class, () -> {
            new Lot(lotIdentifier, LOT_NUMBER, CIVIC_ADDRESS, PRICE, DIMENSIONS_SQ_FT, DIMENSIONS_SQ_M, null);
        });
    }
