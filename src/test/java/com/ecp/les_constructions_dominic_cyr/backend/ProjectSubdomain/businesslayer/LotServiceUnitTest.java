...
public class LotServiceUnitTest {
    ...
    public void whenLotsExist_thenReturnAllLots() {
        // arrange
        var e1 = buildLotEntity("db43c148-68de-4882-818a-d15dc8d5fcdb", "Lot-109", "Chicoutimi, QC", 160000.0f, "8775", "815", LotStatus.SOLD, "proj-002-panorama");
        var e2 = buildLotEntity("adb6f5b7-e036-49cf-899e-a39dcaecd91f", "Lot-110", "Baie-Comeau, QC", 145000.0f, "7500", "696", LotStatus.AVAILABLE, "proj-002-panorama");
    ...
    public void whenGetByIdFound_thenReturnDto() {
        ...
        var entity = buildLotEntity(id, "Lot-123", "FoundLoc", 150f, "1500", "139.4", LotStatus.AVAILABLE, null);
    ...
    public void whenUpdateExisting_thenReturnUpdatedDto() {
        String id = "upd-id-1";
        var stored = buildLotEntity(id, "Lot-789", "OldLoc", 50f, "500", "46.5", LotStatus.AVAILABLE, null);
    ...
    public void whenDeleteExisting_thenDeletes() {
        String id = "del-id-1";
        var stored = buildLotEntity(id, "Lot-999", "Rem", 10f, "100", "9.3", LotStatus.AVAILABLE, null);
        when(lotRepository.findByLotIdentifier_LotId(id)).thenReturn(stored);
