...
class TranslationRegistryControllerIntegrationTest {
    ...
    @Test
    void registerFileId_WithValidData_ReturnsOk() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());

        mockMvc.perform(post("/api/v1/translations/registry/en/home")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("\"file-id-123\""))
                .andExpect(status().isOk())
                .andExpect(content().string(org.hamcrest.Matchers.containsString("File ID registered successfully")));

        verify(registry, times(1)).registerFileId("en", "home", "file-id-123");
    }

    @Test
    void registerFileId_TrimsWhitespace() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());
    ...
    @Test
    void registerFileId_WithUpperCaseLanguage_HandlesCorrectly() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());
    ...
    @Test
    void registerFileId_WithUpperCasePage_HandlesCorrectly() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());
    ...
    @Test
    void registerFileId_WithMultiplePages_RegistersSeparately() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());

        mockMvc.perform(post("/api/v1/translations/registry/en/home")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("\"file-id-home\""))
                .andExpect(status().isOk());

        mockMvc.perform(post("/api/v1/translations/registry/en/projects")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("\"file-id-projects\""))
                .andExpect(status().isOk());

        verify(registry, times(1)).registerFileId("en", "home", "file-id-home");
        verify(registry, times(1)).registerFileId("en", "projects", "file-id-projects");
    }
    @Test
    ...
    @Test
    void registerFileId_WithEmptyFileId_HandlesGracefully() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());
    ...
    @Test
    void registerFileId_WithSpecialCharacters_HandlesCorrectly() throws Exception {
        doNothing().when(registry).registerFileId(anyString(), anyString(), anyString());
        
        mockMvc.perform(post("/api/v1/translations/registry/en/page-name")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("\"file-id-123\""))
                .andExpect(status().isOk());
        
        verify(registry, times(1)).registerFileId("en", "page-name", "file-id-123");
    }
}
