...
public class TranslationRegistry {
    ...
    public TranslationRegistry() {
        ...
        fileIdMap.put("en.realizations", "7a8d4f24-27c2-4a87-a3e8-71839c837ff0");
        fileIdMap.put("fr.realizations", "f457b107-0c94-4e18-8313-aaaf02493d28");
        
        // Residential Projects page translations
        fileIdMap.put("en.residentialprojects", "86ae719b-f49d-42f9-a8da-8d6cfdd06af5");
        fileIdMap.put("fr.residentialprojects", "44286338-ca72-4b68-b55f-08dadb099cca");
        
        // Project Management page translations
        fileIdMap.put("en.projectmanagement", "0fcb5250-a0e7-4657-af1d-e59e0dc84a36");
        fileIdMap.put("fr.projectmanagement", "2cd2154c-3bca-49b2-a458-390a29349743");
        
        // 404 Not Found page translations
        fileIdMap.put("en.notfound", "184ee268-2239-4d1e-8adf-c96c916b56d9");
        fileIdMap.put("fr.notfound", "4a12b63e-4650-42f4-a26e-d22ca4ae531e");
        
        // 500 Server Error page translations
        fileIdMap.put("en.servererror", "212bf6c4-1d43-4de9-8ba4-93e0da0e3342");
        fileIdMap.put("fr.servererror", "92db3316-6377-4761-8fac-1458cff3ef46");
