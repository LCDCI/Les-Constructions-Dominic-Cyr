...
public class QuoteController {
    ...
    @PreAuthorize("hasRole('OWNER')")
    public ResponseEntity<List<QuoteResponseModel>> getAllQuotes() {
        log.info("Fetching all quotes for owner");

        List<QuoteResponseModel> quotes = quoteService.getAllQuotes();
        return ResponseEntity.ok(quotes);
    }
    ...
    public ResponseEntity<QuoteResponseModel> rejectQuote(
        ...
        String ownerId = QuoteMapper.getContractorIdFromAuth(authentication);
        QuoteResponseModel rejectedQuote = quoteService.rejectQuote(quoteNumber, requestModel.getRejectionReason(),
                ownerId);
