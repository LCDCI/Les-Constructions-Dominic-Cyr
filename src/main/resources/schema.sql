...
CREATE INDEX idx_living_env_content_project ON living_environment_content(project_identifier);
CREATE INDEX idx_living_env_content_language ON living_environment_content(language);
CREATE INDEX idx_living_env_amenities_content_id ON living_environment_amenities(living_environment_content_id);
