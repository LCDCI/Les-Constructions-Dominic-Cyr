...
import '../styles/FilesPage.css'; // <-- Correct CSS path
...
export default function FileUploadModal({ projectId, uploadedBy, onClose, onUploadSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!isFileTypeValid(file)) {
            setErrorMessage(`File type not supported. Allowed: PDF, DOCX, XLSX, TXT.`);
            return;
        }
        ...
        try {
            ...
            const msg = error.response?.data?.error || 'Failed to upload document. Please check the file type and size.';
            setErrorMessage(msg);
            setIsLoading(false);
        }
    };
            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <label htmlFor="file-upload">Select Document (PDF, DOCX, XLSX, TXT) - Max {MAX_FILE_SIZE_MB}MB</label>
                        <input 
                            id="file-upload"
                            type="file" 
