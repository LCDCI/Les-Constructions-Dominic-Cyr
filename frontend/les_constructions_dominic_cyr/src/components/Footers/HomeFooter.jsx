...
import { FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaShieldAlt, FaIdCard } from 'react-icons/fa';
      ...
      <div className="footer-inner">
        ...
        <div className="footer-section">
          ...
          <div className="footer-content">
            ...
            <p className="footer-item">St-Mathieu-de-Beloeil (Québec) J3G 0M9</p>
          </div>
        </div>
...
" target="_blank" rel="noopener noreferrer" className="footer-link">garantiegcr.com</a>
      ...
      <div className="footer-bottom">
        <p className="footer-copyright">
          © {currentYear} Les Constructions Dominic Cyr Inc. Tous droits réservés.
        </p>
      </div>
    </footer>
  );
