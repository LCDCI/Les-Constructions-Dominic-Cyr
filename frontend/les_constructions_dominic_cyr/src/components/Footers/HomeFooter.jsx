    ...
    <footer className="app-footer">
      <div className="footer-inner">
        ...
        <div className="footer-section">
          ...
          <div className="footer-content">
            <p className="footer-item">
              <strong>{t('footer.rbqLabel', 'Régie du bâtiment du Québec')}:</strong> {t('footer.rbq', '8356-0169-03')}
            </p>
            <a
            ...
            <p className="footer-item" style={{ marginTop: '8px' }}>
              <strong>{t('footer.gcrLabel', 'Garantie construction résidentielle')}:</strong> {t('footer.gcr', '11084')}
            </p>
            <a
