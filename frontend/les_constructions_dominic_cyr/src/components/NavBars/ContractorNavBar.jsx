...
import '../../styles/NavBars/contractorNavbar.css';
import {
  GoProject,
  GoInbox,
  GoPackage,
            ...
            <ul className="navbar-menu">
              <li className="navbar-item">
                <Link
                  ...
                  className={`navbar-link ${isActive('/contractor/dashboard')}`}
                  onClick={closeMenu}
                >
          ...
          <div className="navbar-section">
            ...
            <ul className="navbar-menu">
              ...
              <li className="navbar-item">
                <Link
                  to="/quotes"
                  className={`navbar-link ${isActive('/quotes')}`}
                  onClick={closeMenu}
                >
                  <span className="navbar-icon">
              ...
              <li className="navbar-item">
                <Link
                  to="/contractors/documents"
                  className={`navbar-link ${isActive('/contractors/documents')}`}
                  onClick={closeMenu}
                >
                  <span className="navbar-icon">
                    <GoFile />
